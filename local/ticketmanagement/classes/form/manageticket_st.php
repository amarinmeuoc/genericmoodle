...
public function definition() {
    ...
    $category=$DB->get_records('ticket_category',['hidden'=>0],'category ASC','id,category');
    ...
    $subcategory=$DB->get_records('ticket_subcategory', ['categoryid'=>$firstcategoryid,'hidden'=>0],'subcategory ASC','id,subcategory');
