...
class EditFamiliarFormPopup extends \core_form\dynamic_form {
    ...
    public function definition() {
        ...
        $familiar=$DB->get_record('family', ['id'=>$id], '*');
