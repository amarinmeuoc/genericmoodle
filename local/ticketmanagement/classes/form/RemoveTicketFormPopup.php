...
class RemoveTicketFormPopup extends \core_form\dynamic_form {
    ...
    public function definition() {
        ...
        $mform->addElement('select', 'confirmop', get_string('confirm_remove', 'local_ticketmanagement'), ['yes'=>'Yes', 'no'=>'No']);
        $mform->setDefault('confirmop','no');
