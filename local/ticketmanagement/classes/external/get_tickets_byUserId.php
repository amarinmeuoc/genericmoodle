...
class get_tickets_byUserId extends \core_external\external_api {
/**
        ...
        return new external_function_parameters([
            'params'=>new external_multiple_structure(
                new external_single_structure([
                   ...
                   'userid' => new external_value(PARAM_INT, 'ID del aprendiz'),
    ...
    public static function execute($params) {
       ...
       // $params=self::validate_parameters(self::execute_parameters(), ['newTicket' => $newTicket]);
        ...
        $total_records = $DB->get_records_sql($sqlTotal, ['userid'=>$userid]);
        ...
        $tickets = $DB->get_records_sql($sql, ['userid'=>$userid]);
