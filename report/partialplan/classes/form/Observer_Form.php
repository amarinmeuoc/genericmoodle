...
class Observer_Form extends \moodleform {
    ...
    public function definition() {
        ...
        //$PAGE->requires->js('/report/partialplan/js/observer_formJS.js', false);
        ...
        //Obtener el customerid de la tabla customer usando get_field
