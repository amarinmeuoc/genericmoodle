define([
   ...
   /* Metodos responsables de la carga de proyectos */
    ...
    async function createPDFAcroField(PDF) {
        ...
        const canvas = document.getElementById('myBarChartTickets');
        const canvasImageData = await canvasToImage(canvas);
        const chartImage = await pdfDoc.embedPng(canvasImageData);
    
        // Load other images
        const logoNavantiaURL = M.cfg.wwwroot + '/blocks/charts/pix/navantia-logo.png';
        ...
        const fondoURL = M.cfg.wwwroot + '/blocks/charts/pix/marco-horizontal-navantia.jpg';
        ...
        const text = 'Chart: Total Tickets';
        const textSize = 24;
